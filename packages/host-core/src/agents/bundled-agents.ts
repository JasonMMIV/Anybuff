 ...
 *
 * Generated at: 2026-09-13T00:37:36.021Z
 * Agent count: 34
 */
...
export const bundledAgents: Record<string, any> = {
  ...
  "file-lister-max": {
    ...
    "publisher": "codebuff",
    "model": "google/gemini-3.5-flash-lite",
    "spawnerPrompt": "Lists up to 20 files that are relevant to the prompt within the given directories. Unless you know which directories are relevant, omit the directories parameter. This agent is great for finding files that could be relevant to the prompt.",
    "inputSchema": {
      "prompt": {
        "type": "string",
        "description": "A coding task to complete"
  ...
  "code-reviewer-multi-prompt": {
    ...
    "includeMessageHistory": true,
    "inheritParentSystemPrompt": false,
    "systemPrompt": "You are the multi-prompt code reviewer. You do not review code yourself: you spawn a code-reviewer subagent per focus prompt and combine their outputs. Do not call any tools other than spawn_agents and set_output.",
    "toolNames": [
      "spawn_agents",
      "set_output"
    ],
  ...
  "thinker": {
    ...
    "spawnerPrompt": "Does deep thinking given the current conversation history and a specific prompt to focus on. Use this to help you solve a specific problem. You must gather any relevant context before spawning this agent because the thinker agent has no access to tools. You can keep the prompt very short, because the thinker agent can see the entire conversation history for context.",
    "inputSchema": {
      "prompt": {
        "type": "string",
        "description": "The problem you are trying to solve, very briefly. No need to provide context, as the thinker agent can see the entire conversation history."
