...
/**
 * Resolve the API key from the environment for AnyBuff.
 * Prefers ANYBUFF_API_KEY and falls back to CODEBUFF_API_KEY.
 */
export const getAnybuffApiKeyFromEnv = (): string | undefined => {
  return process.env.ANYBUFF_API_KEY ?? process.env.CODEBUFF_API_KEY
}
