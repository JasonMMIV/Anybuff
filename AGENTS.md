...
- **Compat rules have expiry dates** (§2 non-negotiable #5): verify against live vendor
  ...
  defaults, the DeepSeek reasoning_content backfill (ADR-26 — empty-string
  acceptance verified 2026-09-12 against vendor docs + LiteLLM PR #26660), or
  the verified reasoning-effort ladders in
